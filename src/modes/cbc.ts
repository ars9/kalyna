 ...
 */
export const encryptCBC = (cipherClass: Kalyna, data: Uint8Array, iv: Uint8Array): Uint8Array => {
 ...
 * @param iv Initialization vector
 */
export const decryptCBC = (cipherClass: Kalyna, data: Uint8Array, iv: Uint8Array): Uint8Array => {
